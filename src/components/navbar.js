        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link active mpadding " to="#">Add Leads</Link>
              </li>
            ...
            <form className="d-flex">
              ...
              <button className="btn btn-outline-none logout my-2 px-3" type="logout"><Link to="#">< img src={LogoutImg} alt="logout_Image" /></Link></button>
          </div>
        </div>
      </nav>
    </div>
